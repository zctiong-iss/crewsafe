# This lock selection is copied from the reviewed CrewSafe Terraform roots.
# Terraform Validation verifies it with -lockfile=readonly; do not regenerate it locally.

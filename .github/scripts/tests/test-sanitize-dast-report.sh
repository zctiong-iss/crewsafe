...
jq -n \
  --arg secret "$secret" \
  '{
    about: { version: "2.17.0", generated: "2026-08-18T10:00:00Z" },
    site: [{
...
printf '{not-json}\n' >"$malformed"
jq -n '{about:{version:"2.17.0",generated:"2026-08-18T10:00:00Z"},site:[],insights:[{key:"insight.endpoint.total",statistic:"0"}]}' >"$zero"

...
/**
 * Manager-facing view of the deployed WBGT model's approval status and accuracy
 * (SCRUM-150). Not site-scoped: the model is a single global artifact, unlike
 * {@link ForecastController}'s per-site forecasts.
 */
@RestController
